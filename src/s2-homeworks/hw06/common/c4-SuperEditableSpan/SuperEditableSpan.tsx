...
const SuperEditableSpan: React.FC<SuperEditableSpanType> = (
    ...
    const onEnterCallback = () => {
        setEditMode(false); // Disable editMode when Enter is pressed
        onEnter?.();
    };
    const onBlurCallback = (e: React.FocusEvent<HTMLInputElement>) => {
        setEditMode(false); // Disable editMode when the input loses focus
        onBlur?.(e);
    };
    const onDoubleClickCallBack = (
        e: React.MouseEvent<HTMLSpanElement, MouseEvent>
    ) => {
        setEditMode(true); // Enable editMode when the span is double-clicked
        onDoubleClick?.(e);
    };
